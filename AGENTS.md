...
4. Heavy compute leaves the MacBook; node/python checks stay local. Exception: `make build-hotkey` (12 Swift files, ~8 s) builds locally at nice 19; `air` is Intel and cannot produce the arm64 binary.
